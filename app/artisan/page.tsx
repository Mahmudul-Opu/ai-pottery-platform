        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <Card className="border-2">
            <CardHeader>
              ...
              <CardDescription>Multi-dimensional feedback scores</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-6">
                ...
                <div className="text-center p-6 bg-gradient-to-br from-amber-50 to-orange-50 rounded-xl border-2 border-amber-200">
                  ...
                  <p className="text-5xl font-bold text-amber-600 mb-1">87%</p>
                    ...
                    return (
                      <div key={index} className="space-y-2">
                        <div className="flex items-center justify-between">
                          ...
                          <span className={`text-sm font-bold ${color.text}`}>{item.score}%</span>
                        </div>
